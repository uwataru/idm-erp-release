...
import { MoldManageService } from './mold-manage.service';
import { AppGlobals } from '../../../../app.globals';
import { ActivatedRoute } from '@angular/router';
import { UtilsService } from '../../../../utils.service';
import { MessageService } from '../../../../message.service';
import { Item } from './mold-manage.item';
declare var $: any;


@Component({
  selector: 'app-page',
  templateUrl: './mold-manage.component.html',
  styleUrls: ['./mold-manage.component.css'],
  providers: [MoldManageService],
  encapsulation: ViewEncapsulation.None
})
export class MoldManageComponent implements OnInit {
    ...
    constructor(
        ...
        private dataService: MoldManageService,
    ...
    excelDown() {
        ...
        this.dataService.GetExcelFile().subscribe(
            res => {
                ...
                importedSaveAs(res, "금형보유현황.xlsx");
