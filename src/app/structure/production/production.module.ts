...
export const routes: Routes = [
    ...
    { path: 'results/cutting-works', component: CuttingWorksComponent, data: { title: '생산 > 절단작업입력', id:118 }, canActivate: [AuthGuard] },
    { path: 'results/forging-works', component: ForgingWorksComponent, data: { title: '생산 > 단조생산실적입력', id:119 }, canActivate: [AuthGuard] },
    { path: 'record/forging-result', component: ForgingResultComponent, data: { title: '생산 > 단조작업실적서', id:120 }, canActivate: [AuthGuard] },
    { path: 'aggregation/forging-work-time', component: ForgingWorkTimeComponent, data: { title: '생산 > 단조작업시간집계표', id:121 }, canActivate: [AuthGuard] },
    { path: 'record/cutting-work', component: CuttingWorkComponent, data: { title: '생산 > 절단작업명세서', id:122 }, canActivate: [AuthGuard] },
