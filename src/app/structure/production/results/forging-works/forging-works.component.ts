...
export class ForgingWorksComponent implements OnInit {
    ...
    Save() {
        ...
        f.more_less_qty = f.cutting_qty - f.forging_sum - f.loss_sum + f.lucre_sum;
        ...
        this.dataService.GetById(PocNo).subscribe(
            editData =>
            {
                if (editData['result'] == "success") {
                    ...
                    let more_less_sum = this.formData.cutting_qty - this.formData.forging_sum - this.formData.defective_sum - this.formData.loss_sum + this.formData.lucre_sum;
    ...
    CalculSum(): void {
        ...
        let more_less_qty = cutting_qty - forging_sum - defective_sum - loss_sum + lucre_sum;
