...
import { Item } from './unsold.item';
import { AppGlobals } from '../../../../app.globals';

@Injectable()
export class UnsoldService {

    constructor(
        private http: HttpClient,
        private globals: AppGlobals) { }

    private url = this.globals.serverUrl + '/sales/history/unsold';
    ...
    GetDetailExcelFile () {
        return this.http.get(this.url + '/details/exceldown', {responseType: 'blob'});
    }
