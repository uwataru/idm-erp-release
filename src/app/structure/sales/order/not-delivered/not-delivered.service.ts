...
import { Item } from './not-delivered.item';
import { AppGlobals } from '../../../../app.globals';

const httpOptions = {};

@Injectable()
export class OrderNotDeliveredService {
    ...
    GetDeliveryView (id:number) {
        let currTime = (new Date()).getTime();
        return this.http.get(this.globals.serverUrl + '/sales/not-delivered/delivery/' + id + '?t='+currTime);
    }
