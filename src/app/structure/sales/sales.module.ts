...
export const routes: Routes = [
    { path: '', redirectTo: 'order/order-registration', pathMatch: 'full', canActivate: [AuthGuard] },
    { path: 'order', redirectTo: 'order/order-registration', pathMatch: 'full', canActivate: [AuthGuard] },
    { path: 'order/order-registration', component: OrderRegistrationComponent, data: { title: '영업 > 수주등록', id:103 }, canActivate: [AuthGuard] },
    { path: 'order/order-adjustment', component: OrderAdjustmentComponent, data: { title: '영업 > 수주조정', id:104 }, canActivate: [AuthGuard] },
    { path: 'order/not-delivered', component: OrderNotDeliveredComponent, data: { title: '영업 > 납품처리', id:105 }, canActivate: [AuthGuard] },
    { path: 'order/completion-waiting', component: CompletionWaitingComponent, data: { title: '영업 > 판매처리', id:106 }, canActivate: [AuthGuard] },
    { path: 'order/sales-slips', component: SalesSlipsComponent, data: { title: '영업 > 판매전표처리', id:107 }, canActivate: [AuthGuard] },
    { path: 'loss/loss-handling', component: LossHandlingComponent, data: { title: '영업 > 정기LOSS처리', id:108 }, canActivate: [AuthGuard] },
    { path: 'order/order-change-history', component: OrderChangeHistoryComponent, data: { title: '영업 > 수주조정내역', id:109 }, canActivate: [AuthGuard] },
    { path: 'order/delivery', component: DeliveryComponent, data: { title: '영업 > 납품명세서', id:110 }, canActivate: [AuthGuard] },
    { path: 'order/return', component: ReturnComponent, data: { title: '영업 > 반품명세서', id:111 }, canActivate: [AuthGuard] },
    { path: 'order/inferior-goods', component: InferiorGoodsComponent, data: { title: '영업 > 납품불량명세서', id:112 }, canActivate: [AuthGuard] },
