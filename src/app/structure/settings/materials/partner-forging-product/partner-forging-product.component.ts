...
import { PartnerForgingProductService } from './partner-forging-product.service';
import { AppGlobals } from '../../../../app.globals';
import { ActivatedRoute } from '@angular/router';
import { UtilsService } from '../../../../utils.service';
import { MessageService } from '../../../../message.service';
import { Item, PartnerItem } from './partner-forging-product.item';
import {saveAs as importedSaveAs} from "file-saver";
import {ElectronService} from "../../../../providers/electron.service";
declare var $: any;
@Component({
  selector: 'app-page',
  templateUrl: './partner-forging-product.component.html',
  styleUrls: ['./partner-forging-product.component.css'],
  providers: [PartnerForgingProductService]
})
export class PartnerForgingProductComponent implements OnInit {
    ...
    constructor(
        ...
        private dataService: PartnerForgingProductService,
    ...
    onSelectInputForgingPartner(event: TypeaheadMatch): void {
        if (event.item == '') {
            this.inputForm.controls['forging_partner_code'].setValue(0);
        } else {
            this.inputForm.controls['forging_partner_code'].setValue(event.item.Code);
        }
    }
            ...
            editData =>
            {
                if (editData['result'] == "success") {
                    ...
                    this.inputForm.patchValue({
                        ...
                        forging_partner_code: this.formData.forging_partner_code,
                        forging_partner_name: this.formData.forging_partner_name,
    ...
    Save () {
         ...
         formData.cut_length = formData.cut_length * 1;
         formData.size = formData.size * 1;
         formData.input_weight = formData.input_weight * 1;
