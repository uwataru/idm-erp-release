...
@Injectable()
export class WorkingGroupLeaderService {

    constructor(
        private http: HttpClient,
        private globals: AppGlobals) { }

    private url = this.globals.serverUrl + '/production-line-workers';
    private url_period = this.globals.serverUrl + '/production-line-workers-period';
    ...
    GetById (id:number): Observable<Item> {
        return this.http.get<Item>(this.url_period+'/'+id);
    }
    ...
    Update (id:number, data:Item): Observable<Item> {
        return this.http.put<Item>(this.url_period+'/'+id, data, httpOptions);
    }

    /** DELETE: 데이터 삭제 */
    Delete (id:number): Observable<Item> {
        return this.http.delete<Item>(this.url_period+'/'+id, httpOptions);
    }
