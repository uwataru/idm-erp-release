...
import { HeatingProcessService } from './heating-process.service';
import { AppGlobals } from '../../../../app.globals';
import { ActivatedRoute } from '@angular/router';
import { ConfigService } from '../../../../config.service';
import { MessageService } from '../../../../message.service';
import { Item } from './heating-process.item';
declare var $: any;
@Component({
    selector: 'app-page',
    templateUrl: './heating-process.component.html',
    styleUrls: ['./heating-process.component.css'],
    providers: [HeatingProcessService]
})

export class HeatingProcessComponent implements OnInit {
    panelTitle: string;
    ...
    constructor(
        ...
        private dataService: HeatingProcessService,
    ...
    ngOnInit() {
        this.panelTitle = '열처리공정';
        this.inputFormTitle = '열처리공정 등록';
        this.deleteFormTitle = '열처리공정 삭제';
