...
export const routes: Routes = [
  {path: '', redirectTo: 'partners', pathMatch: 'full', canActivate: [AuthGuard]},
  {path: 'partners', redirectTo: 'partners', pathMatch: 'full', canActivate: [AuthGuard]},
  {path: 'partners', component: PartnersComponent, data: {title: '환경설정 > 영업 > 거래처등록', id: 4, level: 2, parent_id: 1 }, canActivate: [AuthGuard]},
  {path: 'products', redirectTo: 'products', pathMatch: 'full', canActivate: [AuthGuard]},
  {path: 'products', component: ProductsComponent, data: {title: '환경설정 > 자재 > 제품등록', id:6, level: 2, parent_id: 5 }, canActivate: [AuthGuard]},
  {path: 'materials/list/ptype2', redirectTo: 'materials/list/ptype2', pathMatch: 'full', canActivate: [AuthGuard]},
  {path: 'materials/list/ptype2', component: MaterialsComponent, data: {title: '환경설정 > 자재 > 원자재물품등록', id: 7, level: 2, parent_id: 5}, canActivate: [AuthGuard]},
  {path: 'materials/list/ptype4', component: PartnerAssemblyProductComponent, data: {title: '환경설정 > 자재 > 외주물품등록', id: 8, level: 2, parent_id: 5}, canActivate: [AuthGuard]},
  {path: 'production/worklines', redirectTo: 'production/worklines', pathMatch: 'full', canActivate: [AuthGuard]},
  ...
  {path: 'account', redirectTo: 'account', pathMatch: 'full', canActivate: [AuthGuard]},
  {path: 'account', component: AccountsComponent, data: {title: '환경설정 > 계정관리 > 계정과목등록', id: 13, level: 2, parent_id: 12}, canActivate: [AuthGuard]},
  {path: 'account', component: AcctMgmtItemsComponent, data: {title: '환경설정 > 계정관리 > 관리항목등록', id: 14, level: 2, parent_id: 12}, canActivate: [AuthGuard]},
  {path: 'account', component: AcctMgmtItemValuesComponent, data: {title: '환경설정 > 계정관리 > 관리내역등록', id: 15, level: 2, parent_id: 12}, canActivate: [AuthGuard]},
