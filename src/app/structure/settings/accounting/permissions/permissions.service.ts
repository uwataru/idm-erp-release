...
export class PermissionsService {
    ...
    private url = this.globals.serverUrl + '/permissions';
    ...
    GetApprovalLine (menuId) {
        return this.http.get(this.url + '/approval-line/' + menuId);
    }
    ...
    Update (data:Item): Observable<Item> {
        return this.http.post<Item>(this.url, data, httpOptions);
    }

    UpdateApprovalLine (data:Item): Observable<Item> {
        return this.http.post<Item>(this.url + '/approval-line', data, httpOptions);
    }
