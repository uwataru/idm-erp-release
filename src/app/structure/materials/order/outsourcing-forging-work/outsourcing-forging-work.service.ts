...
@Injectable()
export class OutsourcingForgingWorkService {

    constructor(
        private http: HttpClient,
        private globals: AppGlobals) { }

    private url = this.globals.serverUrl + '/outsourcing/orders/outs-forging-products';

    GetAll (params): Observable<Item[]> {
        return this.http.get<Item[]>(this.globals.serverUrl + '/forging-products', {params: params});
    }

    GetMaterialInfo (code:string): Observable<Item> {
        return this.http.get<Item>(this.globals.serverUrl + '/forging-products/code/' + code);
    }
