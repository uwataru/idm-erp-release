...
@Injectable()
export class HeatTreatmentOutsourcingService {

    constructor(
        private http: HttpClient,
        private globals: AppGlobals) { }

    private url = this.globals.serverUrl + '/production/forging-inventory';
    ...
    GetExcelFile (): Observable<Blob> {
        return this.http.get(this.url + '/H/exceldownH', {responseType: 'blob'}).pipe(
    ...
    Create (data:Item): Observable<Item> {
        return this.http.post<Item>(this.globals.serverUrl + '/outsourcing/orders/outs-heat-treatment', data, httpOptions).pipe(
    ...
    UploadExcelFile (data) {
        return this.http.post(this.globals.serverUrl + '/outsourcing/orders/H/excelupload', data, httpOptions)
    }
