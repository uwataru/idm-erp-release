...
import { OutsourcingVatSlipsService } from './outsourcing-vat-slips.service';
import { AppGlobals } from '../../../../app.globals';
import { saveAs as importedSaveAs } from "file-saver";
import { ActivatedRoute } from '@angular/router';
import { UtilsService } from '../../../../utils.service';
import { MessageService } from '../../../../message.service';
import { Item } from './outsourcing-vat-slips.item';

@Component({
  selector: 'app-page',
  templateUrl: './outsourcing-vat-slips.component.html',
  styleUrls: ['./outsourcing-vat-slips.component.css'],
  providers: [OutsourcingVatSlipsService],
  encapsulation: ViewEncapsulation.None
})
export class OutsourcingVatSlipsComponent implements OnInit {
    ...
    constructor(
        ...
        private dataService: OutsourcingVatSlipsService,
    ...
    excelDown() {
        ...
        this.dataService.GetExcelFile().subscribe(
            res => {
                ...
                importedSaveAs(res, "외주가공 부가세 현황.xlsx");
