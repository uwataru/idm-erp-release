...
import { SalesVatSlipsService } from './sales-vat-slips.service';
import { AppGlobals } from '../../../../app.globals';
import { ActivatedRoute } from '@angular/router';
import { UtilsService } from '../../../../utils.service';
import { MessageService } from '../../../../message.service';
import { Item } from './sales-vat-slips.item';

@Component({
  selector: 'app-page',
  templateUrl: './sales-vat-slips.component.html',
  styleUrls: ['./sales-vat-slips.component.css'],
  providers: [SalesVatSlipsService],
  encapsulation: ViewEncapsulation.None
})
export class SalesVatSlipsComponent implements OnInit {
    ...
    constructor(
        ...
        private dataService: SalesVatSlipsService,
    ...
    ngOnInit() {
        ...
        // 차변계정
        this.inputForm.controls['acct_name'].setValue('외상매출금');
        this.AcctCode = '111032';
    }
    ...
    excelDown() {
        ...
        this.dataService.GetExcelFile().subscribe(
            res => {
                ...
                importedSaveAs(res, "판매 부가세 현황.xlsx");
