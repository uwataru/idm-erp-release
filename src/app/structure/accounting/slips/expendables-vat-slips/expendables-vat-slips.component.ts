...
import { ExpendablesVatSlipsService } from './expendables-vat-slips.service';
...
import { Item } from './expendables-vat-slips.item';

@Component({
  selector: 'app-page',
  templateUrl: './expendables-vat-slips.component.html',
  styleUrls: ['./expendables-vat-slips.component.css'],
  providers: [ExpendablesVatSlipsService],
  encapsulation: ViewEncapsulation.None
})
export class ExpendablesVatSlipsComponent implements OnInit {
    ...
    constructor(
        ...
        private dataService: ExpendablesVatSlipsService,
    ...
    excelDown() {
        ...
        this.dataService.GetExcelFile().subscribe(
            res => {
                ...
                importedSaveAs(res, "소모품 부가세 현황.xlsx");
