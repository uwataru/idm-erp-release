...
@Injectable()
export class ExpendablesVatSlipsService {
    ...
    GetAll (params): Observable<Item[]> {
        return this.http.get<Item[]>(this.url + '/vat', {params: params});
    }

    Create (data): Observable<Item> {
        return this.http.post<Item>(this.url + '/create-vat-slip', data, httpOptions).pipe(
    ...
    GetExcelFile (): Observable<Blob> {
        return this.http.get(this.url + '/exp-vat/exceldown', {responseType: 'blob'}).pipe(
